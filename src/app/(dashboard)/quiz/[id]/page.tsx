...
const QUIZZES: Record<string, {
  ...
  "grade-10-final": {
    ...
    subtitle: "يغطي تحليل البيانات والعملية الكاملة لبناء صفحات الويب بلغة HTML",
    icon: "🎓",
    gradient: "from-orange-600 to-red-600",
    questions: [
      { q: "البيانات الخام قبل معالجتها تُعد:", type: "mc", opts: ["معلومات مفهومة", "معلومات خام غير معالجة", "قرارات نهائية", "رسوماً بيانية"], correct: 1, explanation: "البيانات هي مواد خام تُجمع من مصادر مختلفة قبل معالجتها إلى معلومات مفيدة.", points: 10 },
      { q: "المعلومات الناتجة بعد معالجة البيانات تصلح لـ:", type: "mc", opts: ["الطباعة فقط", "اتخاذ القرارات", "التخزين المؤقت", "حذف الملفات"], correct: 1, explanation: "المعلومات المعالجة مفهومة ومفيدة وتصلح لاتخاذ القرارات.", points: 10 },
      { q: "درجة الحرارة 25 تعتبر بيانات:", type: "mc", opts: ["نصية", "منطقية", "رقمية", "بصرية"], correct: 2, explanation: "البيانات الرقمية أعداد صحيحة أو عشرية مثل الكميات والدرجات والأسعار.", points: 10 },
      { q: "المخطط المناسب لإظهار النسب المئوية من الكل هو:", type: "mc", opts: ["الخطي", "الدائري", "المبعثر", "السهمي"], correct: 1, explanation: "المخطط الدائري يظهر توزيع كل جزء من الكل بنسب مئوية.", points: 10 },
      { q: "أول خطوة في عملية تحليل البيانات هي:", type: "mc", opts: ["جمع البيانات من مصادرها", "رسم المخططات", "اتخاذ القرار", "حذف البيانات"], correct: 0, explanation: "تبدأ عملية تحليل البيانات بجمعها من مصادر موثوقة ثم تنظيفها وتنظيمها وتحليلها.", points: 10 },
      { q: "تحليل البيانات يهدف في النهاية إلى:", type: "mc", opts: ["تخزين البيانات", "استخلاص نتائج واتخاذ قرارات", "طباعة التقارير", "حذف الزائد"], correct: 1, explanation: "الهدف من التحليل هو الوصول إلى معلومات مفيدة تمكن من اتخاذ قرارات صحيحة.", points: 10 },
      { q: "لغة HTML مخصصة لتصميم هيكل صفحات الويب وتُعد لغة ترميز.", type: "tf", opts: ["صحيح", "خطأ"], correct: 0, explanation: "HTML هي لغة ترميز (Markup Language) وليست لغة برمجة.", points: 10 },
      { q: "يبدأ بناء أي صفحة إلكترونية بإعلان:", type: "mc", opts: ["<html>", "<!DOCTYPE html>", "<body>", "<link>"], correct: 1, explanation: "إعلان <!DOCTYPE html> يخبر المتصفح أن الصفحة مكتوبة بلغة HTML5.", points: 10 },
      { q: "الوسم المستخدم لعرض عناوين رئيسية في الصفحة هو:", type: "mc", opts: ["<p>", "<a>", "<h1>", "<img>"], correct: 2, explanation: "<h1> يعرض عنواناً رئيسياً كبيراً و<hn> حتى المستوى السادس للعناوين الفرعية.", points: 10 },
      { q: "لإنشاء قائمة غير مرقمة نستخدم الوسم:", type: "mc", opts: ["<ol>", "<ul>", "<li>", "<list>"], correct: 1, explanation: "<ul> لإنشاء قائمة نقطية غير مرقمة بينما <ol> للقوائم المرقمة.", points: 10 },
      { q: "لعرض صورة في الصفحة نستخدم وسم <img> مع خاصية:", type: "mc", opts: ["href", "src", "alt فقط", "title"], correct: 1, explanation: "خاصية src تحدد مسار الصورة المراد عرضها مثل <img src=\"photo.jpg\">.", points: 10 },
      { q: "لإنشاء ارتباط تشعبي لصفحة أخرى نستخدم:", type: "mc", opts: ["<a href=\"page.html\">", "<link src=\"page\">", "<img href=\"page\">", "<nav>"], correct: 0, explanation: "وسم <a> مع خاصية href يُنشئ ارتباطاً تشعبياً، وإن وجدت سمة target=\"_blank\" يُفتح بتصفح جديد.", points: 10 },
      { q: "لإنشاء جدول ذو صفوف وأعمدة نستخدم الوسوم:", type: "mc", opts: ["<tab><row>", "<table> مع <tr> و<td>", "<grid><col>", "<list><item>"], correct: 1, explanation: "<table> يُنشئ الجدول و<tr> للصفوف و<td> للخلايا و<th> لخلايا العناوين.", points: 10 },
      { q: "الوسم الذي يُستخدم لتشغيل ملف صوتي أو فيديو داخل الصفحة هو:", type: "mc", opts: ["<audio> و<video>", "<music> و<movie>", "<sound>", "<media>"], correct: 0, explanation: "وسما <audio> و<video> يُدرجان الوسائط المتعددة في الصفحات الإلكترونية.", points: 10 },
    ],
  },
};
